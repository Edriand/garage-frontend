  ...
  return (
    <>
      ...
      <main className="max-w-[600px] mx-auto px-5 py-10 pb-24 md:pb-10">
        {/* Page header */}
        <div className="border-b-2 border-dashed border-outline-variant pb-4 mb-8 flex justify-between items-start">
          <div>
          ...
          <div className="flex flex-col gap-1">
            ...
            {photoPreview ? (
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant mb-2">
                Ya tiene foto. Selecciona una nueva para reemplazarla.
              </p>
            ) : null}
        ...
        <div className="mt-10 pt-6 border-t-2 border-dashed border-error/30">
          ...
          <p className="font-body-sm text-body-sm text-on-surface-variant mb-4">
            Eliminar el vehículo borrará todos sus datos e historial de forma permanente.
          </p>
          ...
          {showDeleteConfirm ? (
            <div className="bg-error-container border border-error/30 rounded p-4 space-y-3">
              <p className="font-body-sm text-body-sm text-on-error-container font-bold">
                ¿Confirmas que quieres eliminar este vehículo?
              </p>
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={[
                    ...
                    'font-label-caps text-label-caps px-4 py-2 rounded',
                    'bg-error text-on-error border border-b-4 border-error/80',
                    'shadow-sm active:border-b active:translate-y-px transition-all',
            ...
            <button
              ...
              className={[
                ...
                'font-label-caps text-label-caps px-4 py-2 rounded',
                'text-error border border-error/40 border-b-4',
                'bg-gradient-to-b from-surface to-error-container/20',
                'shadow-sm hover:from-error-container/20 hover:to-error-container/40',
                'active:border-b active:translate-y-px transition-all',
              ].join(' ')}
            >
